/*
  ...
  - You are about to alter the column `passwordResetToken` on the `users` table. The data in that column could be lost. The data in that column will be cast from `String` to `DateTime`.
...
CREATE TABLE "new_users" (
    ...
    "birthDate" TEXT,
    "passwordReseteExpired" TEXT,
    "passwordResetToken" DATETIME,
